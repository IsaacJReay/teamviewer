...
source_x86_64=(
	"https://dl.teamviewer.com/download/linux/version_${pkgver%%.*}x/teamviewer_${pkgver}_amd64.deb"
	"com.teamviewer.TeamViewer.desktop"
)
source_i686=(
	"https://dl.teamviewer.com/download/linux/version_${pkgver%%.*}x/teamviewer_${pkgver}_i386.deb"
	"com.teamviewer.TeamViewer.desktop"
)
source_armv7h=(
	"https://dl.teamviewer.com/download/linux/version_${pkgver%%.*}x/teamviewer_${pkgver}_armhf.deb"
	"com.teamviewer.TeamViewer.desktop"
)
source_aarch64=(
	"https://dl.teamviewer.com/download/linux/version_${pkgver%%.*}x/teamviewer_${pkgver}_arm64.deb"
	"com.teamviewer.TeamViewer.desktop"
)

sha256sums_i686=(
	'ffae8137c023448ec0f046991d67aab493041fa982fec81c7e2f5122793f92be'
	'adfecc6f08b254aea15be5d0db3c42ed16a3f6f832a04dc8b30fb4f944d7cef0'
)
sha256sums_x86_64=(
	'81f8aabea072554c65672ffd466a1f8979f12c21df87a577260dcce34db20e50'
	'adfecc6f08b254aea15be5d0db3c42ed16a3f6f832a04dc8b30fb4f944d7cef0'
)
sha256sums_armv7h=(
	'fa6a96c9914aa55a290234bb9e8318609d725f155e18ec7afd9cd2a93557f3ee'
	'adfecc6f08b254aea15be5d0db3c42ed16a3f6f832a04dc8b30fb4f944d7cef0'
)
sha256sums_aarch64=(
	'2590e9a0207a75be974af3dcc07f5abd7cede7150da9171efe29884a99ea6502'
	'adfecc6f08b254aea15be5d0db3c42ed16a3f6f832a04dc8b30fb4f944d7cef0'
)
...
package() {
	...
	install -Dm755 "${srcdir}"/com.teamviewer.TeamViewer.desktop "${pkgdir}"/opt/teamviewer/tv_bin/desktop/com.teamviewer.TeamViewer.desktop
}
